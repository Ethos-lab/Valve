...
// const receiveRequestSchema = require('/home/app/function/schemas/receive-request-schema.json')
// const productImageSchema = require('/home/app/function/schemas/product-image-schema.json');
console.log()
...
//     catch(e) { }
// };
fs.readdir('/home/app/function/node_modules/', function(err, items) {
    console.log('items')
    console.log(items)
})
            ...
            let executionEnv = {
                ...
                require: {
                    ...
                    mock: {
                        ...
                        // 'ajv' : {
                        //     constructor: () => new AJV(),
                        //     addschema: (param1, param2) => AJV.addschema (param1, param2),
                        //     validate: (param1, param2) => AJV.addschema (param1, param2),
                        //     errorsText: () => AJV.errorsText(),
                        // },
                        'bluebird' : {
                            constructor: (params) => BbPromise.constructor(params),
                            resolve: () => BbPromise.resolve(),
                            resolve: (params) => BbPromise.resolve(params),
                            then: (params) => BbPromise.then(params),
                            reject: (params) => BbPromise.reject(params),
                            config: (params) => BbPromise.config(params),
                            coroutine: (params) => BbPromise.coroutine(params),
                        },
                        'nodemailer' : {
